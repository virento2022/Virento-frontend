        ...
        <>
                            ...
                            <div className="columns-2">
                                <div>
                                    <p className="text-gray-400 leading-loose text-lg">
                                        Ngày nay, với công nghệ phát triển cùng
                                        sự đầy đủ về mặt vật chất, phần lớn
                                        ...
                                        <br />
                                        <br />
                                        Với sứ mệnh giải quyết vấn đề về sự lãng
                                        phí trong tiêu dùng và ảnh hưởng tiêu
                                        cực tới môi trường,{" "}
                                        <span className="font-bold text-green-600">
                                            VIRENTO
                                        </span>{" "}
                                        đã được thành lập bởi một nhóm bạn trẻ
                                        khát khao đóng góp cho xã hội. Đây là
                                        một nền tảng thuê và cho thuê trực tuyến
                                        tại Việt Nam.
                                    </p>
                                </div>
                                <div className="ml-16">
                    ...
                    <div className="container px-8 mx-auto mt-48">
                        <div className="max-w-5xl mx-auto mb-12 text-left">
                            ...
                            <p className="text-gray-400 leading-loose text-xl w-5/6">
                                ...
                                cung cấp giải pháp đi thuê và cho thuê dễ dàng,
                                tiện ích dựa trên 03 trên 17 mục tiêu phát triển
                                bền vững (
                        ...
                        <div className="md:columns-2 lg:columns-4 gap-2 mt-12 ml-24">
                            <div className="mb-4">
                                ...
                                <h3 className="text-gray-400 w-3/4 text-lg">
                            ...
                            <div className="mb-4">
                                ...
                                <h3 className="text-gray-400 w-3/4 text-lg">
                                    Xây dựng đô thị và cộng đồng bền vững
                                </h3>
                            </div>
                            <div className="mb-4">
                                <Image
                                ...
                                <h3 className="text-gray-400 w-3/4 text-lg">
                                    Thúc đẩy tiêu dùng và sản xuất có trách
                                    nhiệm
                                </h3>
                            </div>
                            <div className="mb-4">
                    ...
                    <div className="container px-8 mx-auto">
                        <div className="">
                            ...
                            <p className="text-lg">
                                ...
                                có thể kiếm thêm thu nhập từ việc gia tăng{" "}
                                <br /> lợi ích của những đồ vật ít dùng và gia
                                tăng không gian sống.
                            </p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container px-8 mx-auto">
                        <div className="">
                            ...
                            <p className="text-lg">
                                ...
                                sẽ tiết kiệm được tiền bạc, thời gian và <br />{" "}
                                gia tăng sự đa dạng trong vật phẩm sử dụng.
                            </p>
                        </div>
                    </div>
                </section>
            ...
            <div className="max-w-screen-xl mx-auto">
                <section className="py-12 md:py-20">
                    <div className="container px-8 mx-auto mt-48">
                        <div>
                            <h1 className="text-4xl md:text-6xl mt-4 font-heading mx-auto text-center">
                                OUR CORE VALUES
                            </h1>
                            <h1 className="text-4xl md:text-6xl mb-16 font-heading mx-auto text-center">
                                ____________________
                            </h1>
                        </div>
                        <div className="lg:columns-3 text-center ">
                            <div className="mx-12">
                                <h3 className="font-bold heading text-2xl md:text-3xl mb-2 w-full">
                                    Hiệu quả
                                </h3>
                                <p className="text-gray-400 mb-6 w-full">
                                    Luôn chủ động áp dụng tiến bộ công nghệ
                                    thông tin vào sản phẩm, sẵn sàng cung cấp
                                    các gói dịch vụ đáp ứng đầy đủ nhu cầu về
                                    chất lượng và sự nhanh chóng của người dùng.
                                </p>
                            </div>
                            <div className="mx-12">
                                <h3 className="font-bold heading text-2xl md:text-3xl mb-2 w-full">
                                ...
                                <p className="text-gray-400 mb-6 w-full">
                                    Cam kết tích cực đồng hành cùng người dùng
                                    trong các hoạt động kết nối, giao dịch, vân
                                    chuyển nhằm tăng tính hiệu quả, giảm thiểu
                                    tối đa sai sót hay nhanh chóng khắc phục
                                    thiệt hại nếu có để luôn đảm bảo chất lượng
                                    dịch vụ và trải nghiệm của người dùng.
                                </p>
                            </div>
                            <div className="mx-12">
                                <h3 className="font-bold heading text-2xl md:text-3xl mb-2 w-full">
                                ...
                                <p className="text-gray-400 mb-6 w-full">
                                    Luôn tin tưởng và hành động vì cộng đồng và
                                    những giá trị bền vững thông qua sáng tạo
                                    các giải pháp tiêu dùng xanh, hướng tới các
                                    mục tiêu phát triển bền vững (SDGs) của Liên
                                    Hợp Quốc.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="container px-8 mx-auto mt-48">
                        ...
                        <div className="lg:columns-3 text-lg mt-16 text-center">
                            ...
                            <h4 className="text-green-600 font-bold mb-6">
                                Tiến sĩ Luật và Tài chính, Giảng viên trường Đại
                                học Ngoại thương
                            </h4>
                            <Image src={AD2} height={150} width={150} />
                            <h3>Mr. Hoàng Sơn Công</h3>
                            <h4 className="text-green-600 font-bold mb-6">
                                Tổng giám đốc Trung tâm Hỗ trợ Khởi nghiệp ngành
                                Bán lẻ, Chuyên gia cao cấp lĩnh vực Khởi nghiệp
                                sáng tạo và Nông nghiệp
                            </h4>
                            <Image src={AD3} height={150} width={150} />
                            <h3>Mrs. Nguyễn Thị Quỳnh</h3>
                            <h4 className="text-green-600 font-bold mb-6">
                                Giám đốc công ty TNHH DKS Vietnam Software
                                Technology
                            </h4>
                            <Image src={AD4} height={150} width={150} />
                            <h3>Mr. Nguyễn Đình Đạt</h3>
                            <h4 className="text-green-600 font-bold mb-6">
                                Nhà sáng lập RNR Academy, Giảng viên trường Đại
                                học Ngoại thương
                            </h4>
                            <Image src={AD5} height={150} width={150} />
                            <h3>Mrs. Lương Thị Linh Chi</h3>
                            <h4 className="text-green-600 font-bold mb-6">
                                Chuyên gia tư vấn Luật, Giảng viên trường Đại
                                học Mở
                            </h4>
                            <Image src={AD6} height={150} width={150} />
                            <h3>Mr. Nguyễn Tất Thắng</h3>
                            <h4 className="text-green-600 font-bold mb-6">
                                Tổng giám đốc công ty tư vấn hiệu quả ECO
                                Vietnam
                            </h4>
                        </div>
                    </div>
