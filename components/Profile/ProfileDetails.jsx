                ...
                <div className="xl:w-10/12 w-full px-8">
                    <div className="xl:px-24">
                        <div className="flex justify-center items-center ">
                            <img src="https://cdn-icons-png.flaticon.com/512/109/109718.png?w=740" className="w-32 h-32" alt="display avatar" role="img" />
                        </div>
                        <p className="pt-5 text-center">Cool name here</p>
