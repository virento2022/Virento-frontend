      ...
      <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
        <div className="w-full sm:w-96 md:w-8/12 lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
          <div className="w-full lg:w-8/12 bg-white flex justify-center items-center">
            <Image src={props.images[0]} alt="Wooden Chair Previw" />
          </div>
          <div className="w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
            <div className="bg-white flex justify-center items-center py-4">
              <Image src={props.images[0]} alt="Wooden chair - preview 1" />
            </div>
            <div className="bg-white flex justify-center items-center py-4">
              <Image src={props.images[0]} alt="Wooden chair - preview 2" />
            </div>
            <div className="bg-white flex justify-center items-center py-4">
              <Image src={props.images[0]} alt="Wooden chair- preview 3" />
            </div>
          </div>
        </div>
